...
public class PostDumpFlow {
   ...
   private static final String PROJECT_ID = "alpine-charge-225722";
   private static final String INSTNACE_ID = "around-post";
   private static final String TABLE_ID = "post";
   ...
   public static void main(String[] args) {
       ...
       PCollection<TableRow> bqRows = btRows.apply(ParDo.of(new DoFn<Result, TableRow>() {
        ...
        bqRows.apply(BigQueryIO.Write
                .named("Write")
                .to(PROJECT_ID + ":" + "post_analysis" + "." + "daily_dump_" + new SimpleDateFormat("dd_MM_yyyy").format(new Date()))
                .withSchema(schema)
